...
const modules = [
  { name: "Date to Marry", icon: "https://ik.imagekit.io/hzyuadmua/employees/pepsi_remove_s44QU-UacL.png", active: true },
  { name: "Dating", icon: "https://ik.imagekit.io/hzyuadmua/employees/pepsi_remove_s44QU-UacL.png", active: true },
  { name: "Mature Connection", icon: "https://ik.imagekit.io/hzyuadmua/employees/pepsi_remove_s44QU-UacL.png", active: true },
];
...
const ModulesDropdown = () => {
  ...
  return (
    <ClickOutside onClick={() => setOpen(false)} className="relative">
      ...
      <button
        onClick={() => setOpen(!open)}
        className="flex items-center w-[250px] bg-gray-800 text-white px-10 py-4 "
      >
        {selectedModule.name}
      </button>

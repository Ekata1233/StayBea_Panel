...
const CardDataStats: React.FC<CardDataStatsProps> = ({
  ...
  iconBgColor = "bg-meta-2 dark:bg-meta-4",
}) => {
  return (
    <div
      className={`rounded-sm border border-stroke px-7.5 py-6 shadow-default dark:border-strokedark ${bgColor}`}
    >
      <div
      ...
      <div className="mt-4 flex items-end justify-between">
        ...
        <span className={`flex items-center gap-1 text-sm font-medium ${rateColor}`}>
          {rate}
        </span>
      </div>
    </div>

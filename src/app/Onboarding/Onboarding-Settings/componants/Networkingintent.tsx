...
import {
  ...
  type Field,
  type Option,
} from '../../../../context/Networkingintentcontext'
...
function NewFieldDraft({
  ...
  const { createField } = useNetworkingIntent()
...
export default function NetworkingIntent() {
  const { fields, loading, error, refetch } = useNetworkingIntent()
  ...
  return (
    <Section title="Networking Intent">
      {error && (
      ...
      {loading ? (
        ...
        <div className="py-8 text-center text-sm text-gray-400">
          No networking intent fields yet.
        </div>
      ) : (
